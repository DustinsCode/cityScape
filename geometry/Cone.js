...
class Cone extends Object3D {
     ...
     * @param {props} is an object with the following keys: radius, height,
     * tipColor, baseColor, radialDiv
     */
    constructor (gl, props) { //radius, HEIGHT, props.radialDiv, verticalDiv, props.tipColor, props.baseColor) {
        super(gl);
        ...
        if (typeof props.radius === "undefined")
            alert("Cone: missing radius");
        if (typeof props.height === "undefined")
            alert("Cone: missing height");
